...
do
    ...
    #echo Beginning to make merged catalogue file for image $science_image
    #bash createSingleImageObjectList.bash  $science_image $target_dir "proc_${science_image_root//.fits}.mcat" $yes_or_no_crc_correction  
    ...
    unified_cat_file_name="crc_proc_${science_image//.fits}.mcat"
    #bash createSingleImageObjectList.bash $science_image $target_dir $unified_cat_file_name $yes_or_no_crc_correction

    echo Beginning to make merged catalogue file for image $science_image
    bash createSingleImageObjectList.bash  $science_image $target_dir "proc_${science_image//.fits}.mcat" "proc_${science_image//.fits}.ucat" $yes_or_no_crc_correction

...
repeat_dither=9 #The number of observations after which the dither will repeat
...
filenamesuffixes=("A" "B" "C" "D" "E" "F" "G" "H" "I") #the file name suffixes that will distinguish the file names
raoffsets=( 10  -7 -10 -10   7   7 10 10 -17 ) #the RA offsets
decoffsets=( 7  10  -7  -7 -10 -10 7   7   3 ) #The Decl offsets
total_ra_offset=0
total_dec_offset=0

...
do
	...
	python createColumnsOfWCS.py $target_dir $target_positions $target_wcs_fits $target_wcs_cols $target_image
...
echo science_list_file is $science_list_file and file_prefix is $file_prefix
python createMasterObjectList.py $target_dir $science_list_file $file_prefix $master_cat_file_name
